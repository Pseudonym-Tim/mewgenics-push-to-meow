@echo off
REM Build PushToMeow.dll!

set "DESTINATION_DIR=C:\Users\Pseudonym_Tim\Desktop\Tools\Mewtator\mods\PushToMeow"
...
REM Build...
echo.
echo Building PushToMeow.dll...

cl /LD /O2 /GS- /W3 /D_CRT_SECURE_NO_WARNINGS /TC src\PushToMeow.c /Fe:PushToMeow.dll /link user32.lib
...
del /Q PushToMeow.obj PushToMeow.lib PushToMeow.exp 2>nul
...
copy /Y PushToMeow.dll "%DEPLOY_DIR%\PushToMeow.dll"
